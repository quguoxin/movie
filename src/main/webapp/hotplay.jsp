...
<body>
<div id="hidden">
    <a id="hotplay" href="#" class="first" style="" >热映口碑榜</a>
    <a id="willplay" href="#" class="first"> 最受期待榜</a>
        ...
        $.getJSON(url,"",function (res) {
            if(res.code=200){
                ...
                for (var i=0;i<list.length;i++){
                    ...
                    tmp+=' <div style="float: left; margin-left: 20px"><a href="#"><img src="imgs/movie/'+obj.filePoster+'.jpg"></a></div>';
                    tmp+='<div id="middletail "><div id="filmdetail" style="height: 220px;width:450px ;" >';
                    tmp+='<ul style="list-style: none">';
                    tmp+='<li><a href="#" style="text-decoration-line: none ;font-size: 30px;color: black">'+obj.fileName+'</a></li>';
                    ...
                    if(keyv>0.0){
                        ...
                        tmp+=' <div style="float: left; width: 200px;height: 220px" id="filmprice">总想看:'+obj.filePrice+'</div></div></div>';
                        $("#filmcontainer").html(tmp);
                    }
